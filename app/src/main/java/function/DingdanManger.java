        ...
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String Url;
                    if (type.equals("当前预约"))
                        Url = "http://" + context.getResources().getText(R.string.ip_address) + ":8080/VenueManager/personalBookInfoServlet" + "?type=new" + "&userName=" + userName;
                    else
                        Url = "http://" + context.getResources().getText(R.string.ip_address) + ":8080/VenueManager/personalBookInfoServlet" + "?type=old" + "&userName=" + userName;
                    Log.i("url", Url);
                    URL url = new URL(Url);
